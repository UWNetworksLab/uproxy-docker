...
/***/ function(module, exports, __webpack_require__) {
	...
	function signAddon(_ref) {
	  ...
	  var timeout = _ref$timeout === undefined ? undefined : _ref$timeout;
	  var _ref$downloadDir = _ref.downloadDir;
	  var downloadDir = _ref$downloadDir === undefined ? undefined : _ref$downloadDir;
	  var _ref$apiProxy = _ref.apiProxy;
	  var apiProxy = _ref$apiProxy === undefined ? undefined : _ref$apiProxy;
	  var _ref$apiRequestConfig = _ref.apiRequestConfig;
	  var apiRequestConfig = _ref$apiRequestConfig === undefined ? undefined : _ref$apiRequestConfig;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Client = exports.Client = function () {
	  ...
	  _createClass(Client, [{
	    ...
	    value: function configureRequest(requestConf) {
	      ...
	      var authToken = _jsonwebtoken2.default.sign({ iss: this.apiKey }, this.apiSecret, {
	        algorithm: "HS256",
	        expiresIn: 60
	      });
	    ...
	    value: function request(method, requestConf) {
	      ...
	      var _ref4$throwOnBadRespo = _ref4.throwOnBadResponse;
	      var throwOnBadResponse = _ref4$throwOnBadRespo === undefined ? true : _ref4$throwOnBadRespo;
	...
	var PseudoProgress = exports.PseudoProgress = function () {
	  function PseudoProgress() {
	    ...
	    var _ref5$preamble = _ref5.preamble;
	    var preamble = _ref5$preamble === undefined ? "" : _ref5$preamble;
	    var _ref5$setInterval = _ref5.setInterval;
	    var setInterval = _ref5$setInterval === undefined ? defaultSetInterval : _ref5$setInterval;
	    var _ref5$clearInterval = _ref5.clearInterval;
	    var clearInterval = _ref5$clearInterval === undefined ? defaultClearInterval : _ref5$clearInterval;
	    var _ref5$stdout = _ref5.stdout;
	    var stdout = _ref5$stdout === undefined ? process.stdout : _ref5$stdout;
